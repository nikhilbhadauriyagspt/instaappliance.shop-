...
import { FiZap, FiSettings, FiCheckCircle, FiShield, FiArrowLeft, FiPlus } from 'react-icons/fi';
...
const MicrowaveOvenRepair = () => {
  ...
  const features = [
    {
      title: "Heating Fix",
      desc: "Repairing magnetrons and high-voltage diodes to heat your food fast.",
      icon: <FiZap />
    },
    {
      title: "Panel Repair",
      desc: "Fixing buttons, touch screens, and timers that are not working.",
      icon: <FiSettings />
    },
    {
      title: "Door Safety",
      desc: "Fixing door latches and switches to prevent radiation leaks.",
      icon: <FiShield />
    },
    {
      title: "Turntable Fix",
      desc: "Repairing motors so your food plates rotate smoothly again.",
      icon: <FiCheckCircle />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Microwave Repair | Fast & Honest Service | Insta Appliance</title>
        <meta name="description" content="Get your microwave fixed today. We repair all countertop and built-in microwave brands with original parts and honesty." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-[#020617] overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
            Microwave <span className="text-indigo-400">Repair</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Quick heating for your meals. We provide safe and honest repair for all types of microwave ovens at your home.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-10">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight tracking-tight">
                  Safe Solutions for <br/>
                  <span className="text-indigo-600">Your Home Kitchen</span>
                </h2>
              </div>

              <p className="text-slate-500 text-lg font-medium leading-relaxed">
                If your microwave is not heating, sparking, or has a dead display, our skilled team can fix it. We prioritize safety and use only original parts. We work on all major brands to make sure your kitchen runs smoothly again without hidden costs.
              </p>

              <div className="grid gap-5">
                {[
                  "Complete safety check for high-voltage parts",
                  "Original parts with 100% guarantee",
                  "Fixed prices with no hidden charges",
                  "Professional workers you can trust"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight">
              Microwave <span className="text-indigo-600">Help</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">We fix all kinds of problems to get your kitchen machine working perfectly.</p>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 lg:p-24 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight tracking-tight relative z-10">
              Microwave Not Heating? <br />
              <span className="text-indigo-400">Fix It Safely Today</span>
            </h2>
