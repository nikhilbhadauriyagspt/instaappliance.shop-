...
import { FiWind, FiSettings, FiCheckCircle, FiArrowLeft, FiPlus } from 'react-icons/fi';
...
const AirConditionerRepair = () => {
  ...
  const features = [
    {
      title: "Fast Cooling",
      desc: "We fix gas leaks and refill gas to make your AC cool like new.",
      icon: <FaSnowflake />
    },
    {
      title: "Deep Cleaning",
      desc: "Complete cleaning of filters and coils for fresh, healthy air.",
      icon: <FiWind />
    },
    {
      title: "Smart Fix",
      desc: "Repairing remote sensors and circuit boards with expert care.",
      icon: <FiSettings />
    },
    {
      title: "Noise Control",
      desc: "Stopping loud sounds and vibrations for a peaceful sleep.",
      icon: <FiCheckCircle />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Air Conditioner Repair | Simple & Fast Cooling | Insta Appliance</title>
        <meta name="description" content="Get your AC fixed today with our fast and honest repair service. We fix all brands with original parts." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-[#020617] overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
            Air Conditioner <span className="text-indigo-400">Repair</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Stay cool and comfortable. We provide quick and honest repair for all types of AC units at your home.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-10">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight tracking-tight">
                  Easy Fix for Your <br/>
                  <span className="text-indigo-600">Cooling System</span>
                </h2>
              </div>

              <p className="text-slate-500 text-lg font-medium leading-relaxed">
                If your AC is not cooling or making loud noises, don't worry. Our friendly team will visit your home, find the problem quickly, and fix it using only original parts. We make sure you get the best cooling without any stress.
              </p>

              <div className="grid gap-5">
                {[
                  "Quick check-up to find gas leaks",
                  "Fixing remote and circuit board issues",
                  "Better cooling with less electricity use",
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight">
              Professional <span className="text-indigo-600">AC Help</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">We offer everything you need to keep your air conditioner running perfectly.</p>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 lg:p-24 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight tracking-tight relative z-10">
              Don't Stay in the Heat <br />
              <span className="text-indigo-400">Fix Your AC Today</span>
            </h2>
