...
import { FiSettings, FiZap, FiTool, FiCheckCircle, FiArrowLeft, FiPlus } from 'react-icons/fi';
...
const OtherAppliances = () => {
  ...
  const features = [
    {
      title: "Small Machine Fix",
      desc: "Repairing blenders, toasters, and kettles with expert care.",
      icon: <FiTool />
    },
    {
      title: "Electrical Help",
      desc: "Fixing loose wires, plugs, and switches for safety.",
      icon: <FiZap />
    },
    {
      title: "Diagnostic Check",
      desc: "Finding hidden problems in any household machine fast.",
      icon: <FiSettings />
    },
    {
      title: "Long Life Fix",
      desc: "Using original parts to make your appliances last longer.",
      icon: <FiCheckCircle />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Other Appliance Repair | Fast & Honest Service | Insta Appliance</title>
        <meta name="description" content="Get your small or large home appliances fixed today. We repair all kinds of machines with original parts and honesty." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-[#020617] overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
            Other Appliances <span className="text-indigo-400">Repair</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            We fix almost everything. From small kitchen gadgets to large home machines, we provide quick and honest help.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-10">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight tracking-tight">
                  Fixing All Your <br/>
                  <span className="text-indigo-600">Home Gadgets</span>
                </h2>
              </div>

              <p className="text-slate-500 text-lg font-medium leading-relaxed">
                Don't throw away your broken gadgets. Our skilled team can fix almost any home appliance. We use professional tools and original parts to make sure your machines work like new again without any hidden costs.
              </p>

              <div className="grid gap-5">
                {[
                  "Quick repair for various home machines",
              ...
              <div className="pt-4">
                <button 
                  onClick={() => openBookingModal('Appliances')}
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight">
              General <span className="text-indigo-600">Help</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">We fix all kinds of gadgets to make your life easier.</p>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 lg:p-24 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight tracking-tight relative z-10">
              Something Else Broken? <br />
              <span className="text-indigo-400">We Can Probably Fix It</span>
            </h2>
