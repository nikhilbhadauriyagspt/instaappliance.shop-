...
import { FiZap, FiSettings, FiCheckCircle, FiArrowLeft, FiPlus } from 'react-icons/fi';
...
const OvenStoveRepair = () => {
  ...
  const features = [
    {
      title: "Burner Fix",
      desc: "Cleaning and repairing gas burners for a strong, blue flame.",
      icon: <FaFire />
    },
    {
      title: "Ignition Fix",
      desc: "Fixing spark plugs and switches so your stove lights up fast.",
      icon: <FiZap />
    },
    {
      title: "Oven Heating",
      desc: "Repairing heating elements and thermostats for perfect baking.",
      icon: <FiSettings />
    },
    {
      title: "Safety Check",
      desc: "Checking for gas leaks and loose valves to keep your home safe.",
      icon: <FiCheckCircle />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Oven & Stove Repair | Fast & Honest Service | Insta Appliance</title>
        <meta name="description" content="Get your gas stove or electric oven fixed today. We repair all major brands with original parts and honesty." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-[#020617] overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
            Oven & Stove <span className="text-indigo-400">Repair</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Cooking made easy again. We provide quick and honest repair for all types of gas stoves, hobs, and electric ovens.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-10">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight tracking-tight">
                  Better Cooking for <br/>
                  <span className="text-indigo-600">Your Home Kitchen</span>
                </h2>
              </div>

              <p className="text-slate-500 text-lg font-medium leading-relaxed">
                If your stove won't light up or your oven is not heating evenly, our skilled team can help. We fix gas leaks, repair igniters, and replace heating elements quickly. We prioritize your kitchen safety and use only original spare parts.
              </p>

              <div className="grid gap-5">
                {[
                  "Quick check for gas leaks & burner clogs",
                  "Original parts with 100% guarantee",
                  "Fixed prices with no hidden charges",
                  "Expert workers you can trust"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight">
              Oven & Stove <span className="text-indigo-600">Help</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">We fix all kinds of problems to get your kitchen cooking perfectly.</p>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 lg:p-24 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight tracking-tight relative z-10">
              Is Your Stove Leaking? <br />
              <span className="text-indigo-400">Fix It Safely Now</span>
            </h2>
