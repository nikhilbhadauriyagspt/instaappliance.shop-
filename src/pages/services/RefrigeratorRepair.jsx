...
const RefrigeratorRepair = () => {
  ...
  const features = [
    {
      title: "Cooling Fix",
      desc: "Repairing compressor and gas leaks to keep your food fresh.",
      icon: <FaSnowflake />
    },
    {
      title: "Electrical Fix",
      desc: "Fixing light, temperature sensors, and wiring issues quickly.",
      icon: <FiZap />
    },
    {
      title: "Smart Repair",
      desc: "Fixing digital control boards and defrost timers with care.",
      icon: <FiSettings />
    },
    {
      title: "Safe Doors",
      desc: "Repairing door seals and hinges to save electricity.",
      icon: <FiCheckCircle />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Refrigerator Repair | Fast & Honest Service | Insta Appliance</title>
        <meta name="description" content="Get your fridge fixed today. We repair all residential refrigerators and freezers with original parts and honesty." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-[#020617] overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
            Refrigerator <span className="text-indigo-400">Repair</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Keep your food fresh. We provide quick and honest repair for all types of fridges and freezers at your home.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-10">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight tracking-tight">
                  Fast Solutions for <br/>
                  <span className="text-indigo-600">Your Refrigerator</span>
                </h2>
              </div>

              <p className="text-slate-500 text-lg font-medium leading-relaxed">
                If your fridge is not cooling or leaking water, our skilled team can help. We fix compressors, refill gas, and solve electrical issues quickly. We only use original parts to make sure your food stays fresh and healthy.
              </p>

              <div className="grid gap-5">
                {[
                  "Quick repair for all major fridge brands",
                  "Original spare parts with full guarantee",
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight">
              Refrigerator <span className="text-indigo-600">Help</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">We fix all kinds of problems to keep your food and drinks cold.</p>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 lg:p-24 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight tracking-tight relative z-10">
              Is Your Food Spoiling? <br />
              <span className="text-indigo-400">Let Us Fix Your Fridge</span>
            </h2>
