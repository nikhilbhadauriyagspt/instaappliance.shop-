...
import { FiTv, FiZap, FiSettings, FiCheckCircle, FiArrowLeft, FiPlus } from 'react-icons/fi';
...
const TelevisionRepair = () => {
  ...
  const features = [
    {
      title: "Display Fix",
      desc: "Repairing lines on screen, black spots, or no picture issues.",
      icon: <FiTv />
    },
    {
      title: "Power Fix",
      desc: "Fixing power supply units if your TV won't turn on.",
      icon: <FiZap />
    },
    {
      title: "Smart Setup",
      desc: "Helping with Wi-Fi, software, and connectivity problems.",
      icon: <FiSettings />
    },
    {
      title: "Sound Fix",
      desc: "Repairing speakers and audio ports for clear sound.",
      icon: <FiCheckCircle />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Television Repair | Fast & Honest Service | Insta Appliance</title>
        <meta name="description" content="Get your TV fixed today. We repair all LED, LCD, and Smart TVs with original parts and honesty." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-[#020617] overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
            Television <span className="text-indigo-400">Repair</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Get back to your favorite shows. We provide quick and honest repair for all types of LED, LCD, and Smart TVs.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-10">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight tracking-tight">
                  Clear Picture for <br/>
                  <span className="text-indigo-600">Your Home TV</span>
                </h2>
              </div>

              <p className="text-slate-500 text-lg font-medium leading-relaxed">
                If your TV has screen issues, power problems, or sound trouble, our team can fix it. We work on all major brands and use only original parts. We make sure your entertainment setup is perfect again without any hidden costs.
              </p>

              <div className="grid gap-5">
                {[
                  "Quick check-up for all LED & Smart TVs",
                  "Original parts with 100% guarantee",
                  "Fixed prices with no hidden charges",
                  "Experienced workers you can trust"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight">
              Television <span className="text-indigo-600">Help</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">We fix all kinds of problems to get your screen working perfectly.</p>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 lg:p-24 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight tracking-tight relative z-10">
              Is Your Screen Blank? <br />
              <span className="text-indigo-400">Let Us Fix Your TV</span>
            </h2>
