...
const KitchenChimneyRepair = () => {
  ...
  const features = [
    {
      title: "Deep Cleaning",
      desc: "Removing grease and oil from filters and blowers for better suction.",
      icon: <FiWind />
    },
    {
      title: "Motor Fix",
      desc: "Repairing or replacing chimney motors to stop loud noises.",
      icon: <FiZap />
    },
    {
      title: "Panel Repair",
      desc: "Fixing buttons, touch controls, and lights quickly.",
      icon: <FiSettings />
    },
    {
      title: "Smoke Control",
      desc: "Testing suction power to make your kitchen smoke-free.",
      icon: <FiCheckCircle />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Kitchen Chimney Repair | Fast & Honest Service | Insta Appliance</title>
        <meta name="description" content="Get your kitchen chimney fixed today. We clean and repair all brands with original parts and honesty. Same-day service available." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-[#020617] overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
            Kitchen Chimney <span className="text-indigo-400">Repair</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Keep your kitchen smoke-free. We provide quick cleaning and honest repair for all types of chimneys.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-10">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight tracking-tight">
                  Clean Air for <br/>
                  <span className="text-indigo-600">Your Modern Kitchen</span>
                </h2>
              </div>

              <p className="text-slate-500 text-lg font-medium leading-relaxed">
                If your chimney has low suction, makes loud noises, or the buttons aren't working, our skilled team can help. We provide deep cleaning and mechanical repairs using only original parts. We work on all major brands to keep your kitchen oil-free and fresh.
              </p>

              <div className="grid gap-5">
                {[
                  "Complete oil & grease cleaning service",
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight">
              Kitchen Chimney <span className="text-indigo-600">Help</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">We fix all kinds of problems to keep your kitchen fresh and clean.</p>
          </div>
