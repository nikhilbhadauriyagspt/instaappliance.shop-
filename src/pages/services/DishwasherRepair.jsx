...
const DishwasherRepair = () => {
  ...
  const features = [
    {
      title: "Pump Fix",
      desc: "Repairing or replacing pumps to make sure water drains perfectly.",
      icon: <FiDroplet />
    },
    {
      title: "Heating Fix",
      desc: "Fixing heating elements so your dishes come out dry and clean.",
      icon: <FiZap />
    },
    {
      title: "No More Leaks",
      desc: "Repairing door seals and valves to keep your floor dry.",
      icon: <FiSettings />
    },
    {
      title: "Smart Repair",
      desc: "Expert fix for control panels and digital error codes.",
      icon: <FiCheckCircle />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Dishwasher Repair | Fast & Honest Service | Insta Appliance</title>
        <meta name="description" content="Get your dishwasher fixed today. We repair all major brands with original parts and honesty. Same-day service available." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-[#020617] overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
            Dishwasher <span className="text-indigo-400">Repair</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Stop washing by hand. We provide quick and honest repair for all types of dishwashers at your home.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-10">
              ...
              <p className="text-slate-500 text-lg font-medium leading-relaxed">
                If your dishwasher is not cleaning, leaking, or making loud noises, our skilled team can help. We fix pumps, heating elements, and electronic panels quickly. We only use original parts to make sure your machine works perfectly for a long time.
              </p>

              <div className="grid gap-5">
                {[
                  "Quick check-up for all major dishwasher brands",
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight">
              Dishwasher <span className="text-indigo-600">Help</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">We fix all kinds of problems to get your machine working perfectly.</p>
          </div>
