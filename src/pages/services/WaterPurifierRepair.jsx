...
import { FiDroplet, FiZap, FiSettings, FiCheckCircle, FiArrowLeft, FiPlus } from 'react-icons/fi';
...
const WaterPurifierRepair = () => {
  ...
  const features = [
    {
      title: "Filter Change",
      desc: "Replacing old filters to make sure your water is pure and safe.",
      icon: <FiDroplet />
    },
    {
      title: "Pump Fix",
      desc: "Repairing the water pump for fast and steady water flow.",
      icon: <FiZap />
    },
    {
      title: "RO Service",
      desc: "Complete check-up of the RO membrane and cleaning of the tank.",
      icon: <FiSettings />
    },
    {
      title: "Quality Check",
      desc: "Testing water TDS levels to ensure 100% purity for your family.",
      icon: <FiCheckCircle />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Water Purifier Repair | Fast & Honest Service | Insta Appliance</title>
        <meta name="description" content="Get your RO or water purifier fixed today. We repair all major brands with original filters and honesty." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-[#020617] overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
            Water Purifier <span className="text-indigo-400">Repair</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Drink safe, stay healthy. We provide quick and honest repair for all types of RO and water purifiers at your home.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-10">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight tracking-tight">
                  Pure Water for <br/>
                  <span className="text-indigo-600">Your Whole Family</span>
                </h2>
              </div>

              <p className="text-slate-500 text-lg font-medium leading-relaxed">
                If your water tastes different or your RO is leaking, our skilled team can help. We replace filters, fix pump issues, and clean the system quickly. We only use original spare parts to make sure you always get clean and safe drinking water.
              </p>

              <div className="grid gap-5">
                {[
                  "Quick filter and RO membrane replacement",
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight">
              Water Purifier <span className="text-indigo-600">Help</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">We fix all kinds of problems to keep your drinking water safe and pure.</p>
          </div>
