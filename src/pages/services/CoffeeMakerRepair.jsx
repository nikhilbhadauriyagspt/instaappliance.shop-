...
import { FiCoffee, FiZap, FiSettings, FiCheckCircle, FiArrowLeft, FiPlus } from 'react-icons/fi';
...
const CoffeeMakerRepair = () => {
  ...
  const features = [
    {
      title: "Heating Fix",
      desc: "Repairing elements to make sure your coffee is always hot.",
      icon: <FiCoffee />
    },
    {
      title: "Pump Repair",
      desc: "Fixing water flow and pressure for the perfect brew.",
      icon: <FiZap />
    },
    {
      title: "Deep Clean",
      desc: "Removing buildup and blockages to improve coffee taste.",
      icon: <FiSettings />
    },
    {
      title: "No More Leaks",
      desc: "Fixing seals and valves to keep your counter dry.",
      icon: <FiCheckCircle />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Coffee Maker Repair | Fast & Honest Service | Insta Appliance</title>
        <meta name="description" content="Get your coffee machine fixed today. We repair all residential and commercial coffee makers with original parts and honesty." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-[#020617] overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
            Coffee Maker <span className="text-indigo-400">Repair</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Don't miss your morning coffee. We provide quick and honest repair for all types of coffee and espresso machines.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-10">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight tracking-tight">
                  Perfect Brew for <br/>
                  <span className="text-indigo-600">Your Daily Routine</span>
                </h2>
              </div>

              <p className="text-slate-500 text-lg font-medium leading-relaxed">
                If your coffee machine is not heating or leaking, our skilled team can fix it. We work on all major brands and handle both home and office machines. We only use original parts to make sure your machine makes great coffee for a long time.
              </p>

              <div className="grid gap-5">
                {[
                  "Quick check for heating & pump issues",
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight">
              Coffee Maker <span className="text-indigo-600">Help</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">We fix all kinds of problems to get your machine brewing perfectly.</p>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 lg:p-24 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight tracking-tight relative z-10">
              ...
              <span className="text-indigo-400">Let Us Fix Your Brewer</span>
            </h2>
